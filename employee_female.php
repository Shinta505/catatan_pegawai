                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-danger table-striped">
                            ...
                            <tbody>
                                ...
                                $query = mysqli_query($connect, "SELECT * FROM employees WHERE gender = 'Perempuan'");
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><img src="<?php echo $data['foto']; ?>" alt=""></td>
                                        ...
                                        <td><a href="employee_edit.php?employee_id=<?php echo $employee_id; ?>" type="button" class="btn btn-light">Edit</a></td>
                                        <td><a href="#" type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#deleteModal<?php echo $employee_id; ?>">Hapus</a></td>

                                        <!-- Modal Hapus Pegawai -->
                                        <div class="modal fade" id="deleteModal<?php echo $employee_id; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tidak</button>
                                                        <a href="employee_delete.php?employee_id=<?php echo $employee_id; ?>" class="btn btn-primary">Ya</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
